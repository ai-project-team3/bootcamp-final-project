...
3. 노션 「현재상태 다음세션」 — 지금 어디까지 왔나
4. 처음이면 노션 「핸드오프 말로짓는인형극」
...
- **같은 것을 두 곳에 적지 않는다.** 이름은 `guidelines/1`, 금칙어는 `guidelines/4_금칙어.md`, 프롬프트는 `guidelines/3_프롬프트.md`. 두 곳에 있으면 어느 쪽이 최신인지 아무도 모른다
