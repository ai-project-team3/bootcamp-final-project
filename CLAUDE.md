...
| 자리 | 지금 | 대안 |
|---|---|---|
| 판정 + 생성 | **`gpt-5.6-luna`** — 한 모델, effort 두 설정<br>**판정은 측정으로 확정** (09-20) — JSON 100% · p95 2.4초 · 21.6원 | `claude-haiku-4-5` (ZDR 승인 실패 시) — **미측정, 키 없음**<br>~~`mistral-small-4`~~ 실행 불가 · ~~`gpt-5-nano`~~ ~~`ministral-3-3b`~~ 탈락 |
